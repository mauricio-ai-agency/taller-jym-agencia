  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden mb-10">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-700 to-blue-600 p-6 text-center">
          <h1 className="text-2xl font-bold text-white tracking-tight">Registro de Ingreso</h1>
          <div className="flex items-center justify-center gap-2 text-blue-100 mt-1">
            <Car size={16} />
            <span className="font-medium">Taller JYM</span>
          </div>
        </div>
